...
class ChatMorePage(BasePage):
    ...
    __locators = {'': (MobileBy.ID, ''),
        ...
        'com.chinasofti.rcs:id/pop_10g_window_drop_view': (MobileBy.ID, 'com.chinasofti.rcs:id/pop_10g_window_drop_view'),
        ...
        'com.chinasofti.rcs:id/imageview_msg_image': (MobileBy.ID, 'com.chinasofti.rcs:id/imageview_msg_image'),
        ...
        '音视频通话': (MobileBy.ID, 'cc_chat_input_ic_video'),
