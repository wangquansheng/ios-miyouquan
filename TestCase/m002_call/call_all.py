...
class CallPageTest(TestCase):
    ...
    def test_call_000187(self):
        ...
        # 免提、静音、关闭摄像头、翻转摄像头
        time.sleep(2)
        call.is_element_already_exist('多方视频_免提')
        time.sleep(2)
        call.is_element_already_exist('多方视频_静音')
        time.sleep(2)
        call.is_element_already_exist('多方视频_关闭摄像头')
        time.sleep(2)
        call.is_element_already_exist('多方视频_翻转摄像头')
        # 关闭
        time.sleep(3)
        call.click_close_more_video_popup()
        time.sleep(2)
